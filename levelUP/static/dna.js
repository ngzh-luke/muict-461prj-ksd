...
export function TypingDNA() {
  if (TypingDNA.initialized !== true) {
    ...
    TypingDNA.keyCodes = [
      ...
      83, 84, 85, 86, 87, 88, 89, 90, 32, 222, 188, 190, 186, 187, 189, 191, 48,
    ...
    TypingDNA.lastMouseMoveTime = TypingDNA.lastMouseDownTime =
      new Date().getTime();
    TypingDNA.stopTimes = [];
    ...
    TypingDNA.removeEventListeners = function () {
      if (TypingDNA.isMobile() === 1) {
        if (TypingDNA.isAndroid()) {
          if (TypingDNA.isFirefox()) {
            TypingDNA.document.removeEventListener(
              "input",
              TypingDNA.AndroidKeyUp
            );
            TypingDNA.document.removeEventListener(
              "keydown",
              TypingDNA.AndroidKeyDown
          ...
          TypingDNA.document.removeEventListener(
            "keyup",
            TypingDNA.MobileKeyUp
          );
          TypingDNA.document.removeEventListener(
            "keydown",
            TypingDNA.MobileKeyDown
          );
          TypingDNA.document.removeEventListener(
            "keypress",
            TypingDNA.MobileKeyPress
